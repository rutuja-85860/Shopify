...
return (
    <div>
      ...
      <div className=' d-flex justify-content-evenly'>
        <p style={{marginRight:"500vw",fontSize:"30px"}}>Products</p>
      </div>
            ...
            <div className='row'>
                ...
                {
                    filteredData.map(({ id,thumbnail, title, description,category, price,discountPercentage }) => {
                        return (

                            <>
                                <div className="card col-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 mx-auto m-4 " style={{ width: '20vw',height:'80vh' }}>
                                    <img src={thumbnail}  className="card-img-top" alt="..."   />
                                    <div className="card-body" >
                                    <p className="card-text" >{category}</p>
                                        <h4 className="card-title" >{title}</h4>
                                        <p className="card-text" >{description.substr(0, 60)}</p>
                                         <p className="card-text" >${price}</p>
                                        <p className="card-text" >-{discountPercentage}%</p>
                                        <a href="#" className="btn " style={{backgroundColor:"black",color:"white",width:"7vw",height:"5vh"}} onClick={()=>{addcart({thumbnail,title,description,price,category,id})}}>Add to cart </a>
                                    </div>
                                </div>
